...
def create_matches_table():
    with psycopg2.connect(database="matched_users", user="postgres", password="12345", host='localhost', port='5432') as conn:
...
def create_user_info_table():
    with psycopg2.connect(database="matched_users", user="postgres", password="12345", host='localhost',
                          port='5432') as conn:
        with conn.cursor() as cursor:
            cursor.execute('''
